System.register(["cc"], function (_export, _context) {
  ...
  var _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, EditBox, instantiate, Node, Prefab, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _dec7, _dec8, _dec9, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _descriptor6, _descriptor7, _descriptor8, _crd, ccclass, property, GridManager;
  ...
  return {
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "fd8ffdyGc9FR5z22DbHZR/1", "GridManager-UPDATE", undefined);
      ...
      _export("GridManager", GridManager = (_dec = ccclass('GridManager'), _dec2 = property(EditBox), _dec3 = property(EditBox), _dec4 = property(Prefab), _dec5 = property(Node), _dec6 = property(EditBox), _dec7 = property(Prefab), _dec8 = property(EditBox), _dec9 = property(Prefab), _dec(_class = (_class2 = class GridManager extends Component {
        constructor() {
          super(...arguments);
          ...
          _initializerDefineProperty(this, "inputY", _descriptor7, this);

          _initializerDefineProperty(this, "glow", _descriptor8, this);
        }
          ...
          for (var _j = 0; _j < n; _j++) {
            for (var _i = 0; _i < m; _i++) {
              if (glowArr[n - _j - 1][_i]) {
                ...
                console.log("\u0421\u043E\u0437\u0434\u0430\u043D \u0443\u0437\u0435\u043B: " + _cell.name + ", \u043F\u043E\u0437\u0438\u0446\u0438\u044F: " + _cell.position + "}");
              }
            }
      ...
      }), _descriptor7 = _applyDecoratedDescriptor(_class2.prototype, "inputY", [_dec8], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor8 = _applyDecoratedDescriptor(_class2.prototype, "glow", [_dec9], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
...
//# sourceMappingURL=67d8960399ba645c5f02831c4af4536e9e143f54.js.map